...
spriteAI is a project designed to generate character spritesheets, environment sprites, and item sprites using the OpenAI API and image processing libraries. This tool allows users to create pixel-art and other style animations with customizable states and frames.
...
- `assets/`: Directory for storing generated spritesheets and sprites.
