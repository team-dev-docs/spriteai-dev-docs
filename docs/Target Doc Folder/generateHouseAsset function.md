...
- `description` - Text description of the type of house you want to generate an image for
...
The above will generate 3 images 512x512 in size depicting Victorian style houses.
